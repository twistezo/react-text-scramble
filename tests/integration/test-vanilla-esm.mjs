...
import { createTextScramble, TextScrambleAnimator } from '../../dist/esm/index.mjs'

console.log('\n---> test-vanilla-esm.mjs')

console.log('ESM - Function API test')
...
console.log('\nESM vanilla JS integration tests completed')
